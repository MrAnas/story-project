      ...
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div>
              {" "}
              <a href="/" className="flex items-center space-x-1 text-2xl font-medium text-cyan-700">
                    <img
                      src="/logo.png"
                      alt="N"
                      width="160"
            ...
            <div className="max-w-md mt-4 text-gray-500">
              Story Incly 
              template for startups and indie projects.
            </div>
          </div>
          ...
          <div>
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {navigation.map((item, index) => (
                <a key={index} href="/" className="w-full px-4 py-2 text-gray-500 rounded-md hover:text-cyan-700 focus:text-cyan-700 focus:bg-indigo-100 focus:outline-none ">                 
                    {item}
                </a>
              ))}
            </div>
